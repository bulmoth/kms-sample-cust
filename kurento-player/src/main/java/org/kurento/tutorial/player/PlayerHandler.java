...
public class PlayerHandler extends TextWebSocketHandler {
  ...
  private void start(final WebSocketSession session, JsonObject jsonMessage) {
    ...
    webRtcEndpoint.setTurnUrl("fermi:fermi1004@10.8.0.6:19302?transport=tcp"); // shj add turn
    ...
    webRtcEndpoint.addMediaFlowOutStateChangedListener(new EventListener<MediaFlowOutStateChangedEvent>() {
      @Override
        public void onEvent(MediaFlowOutStateChangedEvent event) {
          log.info("[WebRtcEp Media Flow Out State Changed Event] ::: [{}]", event.getState());
          JsonObject response = new JsonObject();
    ...
    webRtcEndpoint.addMediaFlowInStateChangedListener(new EventListener<MediaFlowInStateChangedEvent>() {
      @Override
        public void onEvent(MediaFlowInStateChangedEvent event) {
          log.info("[WebRtcEp Media Flow In State Changed Event] ::: [{}]", event.getState());
          JsonObject response = new JsonObject();
          response.addProperty("id", "mediaFlowInStateChanged");
        }
    });
    ...
    playerEndpoint.addMediaFlowOutStateChangedListener(new EventListener<MediaFlowOutStateChangedEvent>() {
      @Override
        public void onEvent(MediaFlowOutStateChangedEvent event) {
          log.info("[PlayerEp Media Flow Out State Changed Event] ::: [{}]", event.getState());
          JsonObject response = new JsonObject();
          response.addProperty("id", "mediaFlowInStateChanged");
        }
    });
    playerEndpoint.addMediaFlowInStateChangedListener(new EventListener<MediaFlowInStateChangedEvent>() {
      @Override
        public void onEvent(MediaFlowInStateChangedEvent event) {
          log.info("[PlayerEp Media Flow In State Changed Event] ::: [{}]", event.getState());
          JsonObject response = new JsonObject();
          response.addProperty("id", "mediaFlowInStateChanged");
        }
    });
