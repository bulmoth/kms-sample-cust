...
public class MagicMirrorHandler extends TextWebSocketHandler {
  ...
  private void start(final WebSocketSession session, JsonObject jsonMessage) {
    try {
      ...
      String uri = jsonMessage.get("uri").getAsString();
      ...
      //     1.6F, 1.6F);
      // faceOverlayFilter.setOverlayedImage("/resources/static/img/3065.jpg", -0.5F, 0.5F, 1.0F, 1.0F);
      faceOverlayFilter.setOverlayedImage(uri, 0.0F, 0.0F, 1.0F, 1.0F);
      // faceOverlayFilter.setOverlayedImage(appServerUrl + "/img/3065.jpg", 0.0F, 0.0F, 1.0F, 1.0F);
