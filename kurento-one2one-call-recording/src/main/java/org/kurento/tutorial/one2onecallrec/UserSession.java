...
public class UserSession {
  ...
  private String sdpOfferRecv;
  private String callingTo;
  private String callingFrom;
  private WebRtcEndpoint webRtcEndpoint;
  private WebRtcEndpoint webRtcEndpointRecv;
  private WebRtcEndpoint playingWebRtcEndpoint;
  private final List<IceCandidate> candidateList = new ArrayList<>();
  private final List<IceCandidate> candidateListRecv = new ArrayList<>();
  ...
  public String getSdpOfferRecv() {
    return sdpOfferRecv;
  }

  public void setSdpOfferRecv(String sdpOfferRecv) {
    this.sdpOfferRecv = sdpOfferRecv;
  }
  ...
  public WebRtcEndpoint getWebRtcEndpointRecv(){
    return this.webRtcEndpointRecv;
  }

  public void setWebRtcEndpointRecv(WebRtcEndpoint webRtcEndpointRecv) {
    this.webRtcEndpointRecv = webRtcEndpointRecv;

    if (this.webRtcEndpointRecv != null) {
      for (IceCandidate e : candidateListRecv) {
        this.webRtcEndpointRecv.addIceCandidate(e);
      }
      this.candidateListRecv.clear();
    }
  }
  ...
  public CallMediaPipeline getPipeline(){
    return pipeline;
  }

  public void setPipeline(CallMediaPipeline pipeline){
